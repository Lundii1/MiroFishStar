...
/**
 * Real-time acquisition of Agent Profiles during generation
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Real-time acquisition of simulation configuration during generation
 * @param {string} simulationId
 ...
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 * @param {number} limit - Number of returns
 ...
 * @param {number} limit - Return number limit
 */
