    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM analyzes document content and simulation requirements, extracts reality seeds, and automatically generates an appropriate ontology structure
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, the document is automatically chunked and Zep is called to build a knowledge graph, extracting entities and relationships, and forming temporal memory and community summaries
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Construction Finished</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph construction completed, please proceed to the next step for simulation environment setup</p>
          <button 
            class="action-btn" 
